...
def get_args():
    ...
    parser.add_argument('--input_root', default='datasets/Charades/Charades_v1_480/', type=str)
    parser.add_argument('--save_root', default='datasets/Charades/blip2_coco_features/', type=str)
